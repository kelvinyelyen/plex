            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="py-2 space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                        <div className="flex justify-between items-center font-mono p-3 bg-muted/30 rounded-none">
                        ...
                        <div className="col-span-2 flex justify-between items-center font-mono p-3 bg-muted/30 rounded-none">
                    ...
                    <div className="flex flex-col items-center justify-center p-4 bg-muted/50 rounded-none space-y-2 border border-border/50">
                ...
                <DialogFooter className="flex-col sm:flex-row gap-2 sm:gap-3 sm:justify-center pt-2">
                    <Button variant="outline" size="lg" onClick={onChangeProtocol} className="w-full sm:w-auto gap-2 rounded-none">
                        <Home className="w-4 h-4" />
                        Protocol
                    </Button>
                    <Button onClick={onPlayAgain} size="lg" className="w-full sm:w-auto min-w-[140px] gap-2 rounded-none">
